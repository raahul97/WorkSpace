...
# An object representation of a single line in a hostsupdate.
#
# @author Seth Vargo <sethvargo@gmail.com>
class Entry
  class << self
    # Creates a new HostsUpdate::Entry object by parsing a text line. The
  ...
  # @see https://github.com/customink-webops/hostsupdate/issues/51
  #
  # @return [String, nil]
  #
